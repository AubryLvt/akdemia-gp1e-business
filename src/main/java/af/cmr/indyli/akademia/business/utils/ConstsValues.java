package af.cmr.indyli.akademia.business.utils;
...
public class ConstsValues {
    public static final class ConstsDAO {
        ...
        public static final String EMPLOYEE_SOUSCRIPTION_DAO_KEY = "employeeSouscriptionDAO";
        ...
        public static final String PARTICULAR_SOUSCRIPTION_DAO_KEY = "particularSouscriptionDAO";
        public static final String PLANIFICATION_DAO_KEY = "planificationDAO";
        ...
        public static final String SUB_THEME_DAO_KEY = "subThemeDAO";
        public static final String THEME_DAO_KEY = "themeDAO";
    ...
    public static final class ServiceKeys {
        ...
        public static final String SUB_THEME_SERVICE_KEY = "subThemeService";
        public static final String THEME_SERVICE_KEY = "themeService";
        ...
        public static final String PLANIFICATION_SERVICE_KEY = "planificationService";
