...
public class ConstsValues {
	...
	public static final class ConstsDAO {
		...
		public static final String SUB_TOPIC_DAO_KEY = "subThemeDAO";
		public static final String TOPIC_DAO_KEY = "themeDAO";
	...
	public static final class ServiceKeys {
		...
		public static final String SUB_TOPIC_SERVICE_KEY = "subThemeService";
		public static final String TOPIC_SERVICE_KEY = "themeService";
		...
		public static final String PLANNING_SERVICE_KEY = "planificationService";
