...
public class ReglesGestion {
    ...
    public static final String RG09 = "RG09 : Aucune date de la table session ne doit être nulle.";
    ...
    public static final String RG13 = "RG13 : Lancer la procédure d’annulation si le quota de participantsR n’est pas atteint 15 jours avant le début.";
    ...
    public static final String RG18 = "RG18 : Une formation étant planifiée sur au moins une session ne doit pas être supprimé du système.";
