...
public class CompanyServiceTest {
    ...
    void rollback() throws AkdemiaBusinessException, AccessDeniedException {
        if (this.companyForAllTest != null) this.companyService.deleteById(this.companyForAllTest.getId());
        if (idCreatedCompany != null) this.companyService.deleteById(idCreatedCompany);
    }
