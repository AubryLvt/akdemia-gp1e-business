...
public class ParticularServiceTest {
    ...
    void rollback() throws AkdemiaBusinessException, AccessDeniedException {
        if (this.particularForAllTest != null) this.particularService.deleteById(this.particularForAllTest.getId());
        if (idCratedParticular != null) this.particularService.deleteById(idCratedParticular);
    }
