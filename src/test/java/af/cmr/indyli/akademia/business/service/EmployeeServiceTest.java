...
public class EmployeeServiceTest {
    ...
    void rollback() throws AkdemiaBusinessException, AccessDeniedException {
        if (employeeForAllTest != null) this.employeeService.deleteById(this.employeeForAllTest.getId());
        if (idCratedEmpl != null) this.employeeService.deleteById(idCratedEmpl);
        if (companyForAllTest != null) this.companyService.deleteById(this.companyForAllTest.getId());
